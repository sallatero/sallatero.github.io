...
const About = (props) => {
  ...
  return (
    <div id='about'>
      ...
      <p className='slide-in-top ab-p'>I have a technical background and started my career in IT consultancy. I gained experience in 
      ...
      <p className='slide-in-top ab-p'>As I was very interested in health and personal development at the time, I decided to study 
      ...
      <p className='slide-in-top ab-p'>Life as a real estate agent was fun! I met a lot of people and enjoyed helping them to buy or sell 
        ...
        <p className='slide-in-top ab-p'>Different kinds of experiences and my years of self-examination have given me clarity of who I am, 
