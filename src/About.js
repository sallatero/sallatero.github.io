...
const About = (props) => {
  ...
  return (
    <div id='about'>
      ...
      <p>I am a multi-talented IT engineer with a versatile experience in project work and customer
      ...
      This I can do with designing and implementing new digital services and applications. </p>

      <p>I have a technical background and started my career in IT consultancy. I gained experience in 
        ...
        user testing. After some years I wanted to try something else, since I felt that there was something missing.</p>
      
      <p>As I was very interested in health and personal development at the time, I decided to study 
      ...
      So when I had the possibility to try real estate, I jumped at the chance. </p>

      <p>Life as a real estate agent was fun! I met a lot of people and enjoyed helping them to buy or sell 
        ...
        to focus on taking care of the existing client assignments, which was my place to shine.</p>

        <p>Different kinds of experiences and my years of self-examination have given me clarity of who I am, 
          ...
          learn and challenge myself and am ready to work hard for my dream.</p>
      </div>
    </div>
  )
}
